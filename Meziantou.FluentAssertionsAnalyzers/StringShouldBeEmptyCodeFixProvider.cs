...
public sealed class StringShouldBeEmptyCodeFixProvider : CodeFixProvider
{
    ...
    private static async Task<Document> Rewrite(Document document, SyntaxNode nodeToFix, CancellationToken cancellationToken)
    {
        ...
        var newInvocation = originalMethod
            .WithExpression(((MemberAccessExpressionSyntax)originalMethod.Expression).WithName(IdentifierName("BeEmpty")))
