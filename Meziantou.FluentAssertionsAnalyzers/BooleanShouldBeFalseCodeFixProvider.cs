...
public sealed class BooleanShouldBeFalseCodeFixProvider : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create("MFA005");
    ...
    private static async Task<Document> Rewrite(Document document, SyntaxNode nodeToFix, CancellationToken cancellationToken)
    {
        ...
        var newInvocation = originalMethod
            .WithExpression(((MemberAccessExpressionSyntax)originalMethod.Expression).WithName(IdentifierName("BeFalse")))
