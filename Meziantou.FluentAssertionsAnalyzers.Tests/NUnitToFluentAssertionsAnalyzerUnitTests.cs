...
{
    private static ProjectBuilder CreateProjectBuilder(bool useNUnit4)
    {
        if (useNUnit4)
        {
    ...
    private static Task Assert(string sourceCode, string fix, bool useNUnit4 = false)
    {
        return CreateProjectBuilder(useNUnit4)
...
""");
    ...
    public Task Rethrow()
    {
        return CreateProjectBuilder(useNUnit4: false)
          .WithSourceCode("""
using NUnit.Framework;
